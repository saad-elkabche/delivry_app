...
Color greyLightcolor = const Color(0xfff0f1f3);
Color Greycolor = const Color(0xffA7AEC1);
Color Grey3color = const Color(0xff606060);
Color Grey2color = const Color(0xff1b1f22);
Color perpulshadow = const Color(0xffede3ed);
Color blueColor = const Color(0xff2196f3);
Color greenColor = const Color(0xff01a479);
Color greenLightColor = const Color(0xffe5f6f1);
Color greenLight2Color = const Color(0xffe4ffec);
